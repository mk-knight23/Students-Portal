            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-1 text-left">
                    <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary w-fit border border-primary/20">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-[0.1em]">Internal Operations</span>
                    </div>
                    ...
                    <p className="text-sm text-muted-foreground font-medium max-w-lg">
                        Real-time operational overview across the top 10 Maharashtra demographic hubs.
                        Monitoring 100+ active student nodes.
                    </p>
                </div>
